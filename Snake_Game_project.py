...
# red = pygame.Color(255, 0, 0) # type: ignore
...
# generation random food position
def generation_random_food_position():
    return [
        random.randrange(1, (window_x // 10) * 10),
        random.randrange(1, (window_y // 10) * 10)
    ]

food_position = generation_random_food_position()
direction = 'RIGHT'
score = 0
...
def game_over():
    ...
    go_rect.midtop = (window_x / 2, window_y / 4) #type: ignore
